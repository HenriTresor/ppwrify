          ...
          <div className="px-6 py-5 border-b border-gray-200 bg-white">
            <div className="flex items-center justify-between">
              <div className="min-w-80 flex-1">
                <h1 className="text-2xl font-semibold text-gray-900">{formData.designation}</h1>
                <p className="text-base text-gray-600 mt-1">ID: VP0003</p>
              </div>
              <div className="flex items-center space-x-3">
                <button 
                  onClick={handleSubmit}
                  className="inline-flex items-center px-3.5 py-2.5 border-2 border-indigo-200 text-sm font-medium rounded-lg text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                >
                  {t('savePackaging')}
                </button>
              </div>
