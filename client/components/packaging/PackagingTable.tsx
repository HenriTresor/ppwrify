    ...
    <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden">
      ...
      <div className="bg-white px-6 py-3 flex items-center justify-end border-t border-gray-200">
        <div className="flex items-center space-x-1 border border-gray-300 rounded-lg overflow-hidden">
          <button className="flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 border-r border-gray-300">
            <ChevronLeft className="w-5 h-5 mr-1.5" />
            {t('previous')}
          </button>
          <button className="px-3 py-2 text-sm font-medium text-white bg-gray-50 border-r border-gray-300">1</button>
          <button className="px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 border-r border-gray-300">2</button>
          <button className="px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 border-r border-gray-300">3</button>
          <button className="px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 border-r border-gray-300">...</button>
          <button className="px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 border-r border-gray-300">8</button>
          <button className="px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 border-r border-gray-300">9</button>
          <button className="px-3 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 border-r border-gray-300">10</button>
          <button className="flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">
            {t('next')}
